<template>
    <div id="AddSong" class="container mx-auto max-w-4xl pt-20 px-6">
        ...
        <div class="w-full mb-3 mt-4">
            <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Select Image</label>
            <input
                ...
                type="file" id="image" ref="file" @change="handleFileUpload" />
        </div>

        <SubmitFormButton @submit="addSong" btnText="Add Song" />
    </div>
</template>
