                        ...
                        <div class="flex items-center">
                            <div class="mt-3 text-left">
                                ...
                                <div class="flex flex-wrap my-4">
                                    ...
                                    <div class="mb-3 w-full">
                                        <input
                                            ...
                                            type="file" id="image" ref="fileInput" @change="getUploadedImage" />
                                    </div>
                                </div>

                                <div class="flex justify-center max-w-2xl">
                                    <Cropper ref="cropper" :src="uploadedImage" :stencil-props="{
                                ...
                                <div class="pb-3 flex flex-row-reverse px-4">
                                    <button type="button" v-if="uploadedImage" @click="crop"
